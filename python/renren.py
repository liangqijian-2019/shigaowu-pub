...
COOKIE = 'anonymid=jq7o0wjf-yoc40q; depovince=ZGQT; _r01_=1; ick_login=7bbc73b2-7138-4d72-b635-8a8962478915; first_login_flag=1; ln_uact=shi.gaowu@163.com; ln_hurl=http://hdn.xnimg.cn/photos/hdn521/20121028/1150/h_main_N8xu_096100008de71375.jpg; loginfrom=syshome; ch_id=10016; JSESSIONID=abcnb3OrbxvAMgoBoIZFw; jebe_key=085b9297-b2c9-4f8b-8b05-516f4d1dfbf2%7C1cbb1033eac0de7357478db49946ee23%7C1545979096709%7C1%7C1545979097006; wp_fold=0; jebecookies=c61792eb-a3e5-41a6-abdc-2cc48385981a|||||; _de=0B725AB25083833A855777BB458B199B6DEBB8C2103DE356; p=7b230a7a254bfabc86d814d8f105b6ce3; t=61e38d9685b8d1e63af60fd61c38e6bd3; societyguester=61e38d9685b8d1e63af60fd61c38e6bd3; id=384806863; xnsid=c7369a3'
...
def find_ablumUrl():
    ...
    while 1:
        ...
        if line:
            line = line[:-1]
            photo_url = 'http://photo.renren.com/photo/348359757/album-416572442/v7'
            print(photo_url)
            data = login_renren(photo_url)
            pattern = re.compile(r'http://photo.renren.com/photo/348359757/albumlist/v7')
            ...
            for i in albumid_set:
                album_list = 'http://photo.renren.com/photo/348359757/albumlist/v7'
                print(album_list)
